...
uint256 hashGenesisBlock("0xacbf544701fef4cb2237136b89ceb0799c8fa6810dc670e374b89b07b3adad33");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Bosscoin: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan_Version1 = 24 * 60 * 60; //1 day diff readjustments
static const int64 nTargetSpacing = 60; //1 minute block targets
static const int64 nInterval_Version1 = nTargetTimespan_Version1 / nTargetSpacing; //1440 blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal bosscoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
		...
		//   CTransaction(hash=730f0c8ddc, ver=2, vin.size=1, vout.size=1, nLockTime=0, strTxComment=text:Bosscoin genesis block)
        ...
        // Genesis block
        const char* pszTimestamp = "Mmm Boss!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		txNew.strTxComment = "text:Bosscoin genesis block";
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1386033047;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2506320;
        ...
        assert(block.hashMerkleRoot == uint256("0x82b53278a7497afd360b9b069dd05f2c4a4a7bb78dc3781921cc2a32d6797e92"));
...
//   0xa5, 0xf1 = unique id
unsigned char pchMessageStart[4] = { 0x04, 0xf1, 0x05, 0xfd };
